...
assign      alu_op_add_sub      = alu_op_add | alu_op_sub;
...
// 进行符号位扩展
assign      adder_in1_sign_ext = {{2{adder_in1_sign}}, alu_in1};
assign      adder_in2_sign_ext = {{2{adder_in2_sign}}, alu_in2};
...
assign      shift_in1 = alu_op_sll ? in1_bit_invert : alu_in1[0 +: 32];
