...
// csr指令相关的zimm
`define     I_TYPE_ZIMM_WIDTH                   5
`define     I_TYPE_ZIMM_MSB                     19
`define     I_TYPE_ZIMM_LSB                     15
`define     I_TYPE_ZIMM_LOC                     `I_TYPE_ZIMM_LSB +: `I_TYPE_ZIMM_WIDTH

`define     I_TYPE_SHAMT_WIDTH                  6
`define     I_TYPE_SHAMT_LSB                    20
`define     I_TYPE_SHAMT_MSB                    `I_TYPE_SHAMT_LSB + `I_TYPE_SHAMT_WIDTH - 1
`define     I_TYPE_SHAMT_LOC                    `I_TYPE_SHAMT_LSB +: `I_TYPE_SHAMT_WIDTH

`define     I_TYPE_IMM_WIDTH                    12
`define     I_TYPE_IMM_LSB                      20
`define     I_TYPE_IMM_MSB                      `I_TYPE_IMM_LSB + `I_TYPE_IMM_WIDTH - 1
`define     I_TYPE_IMM_LOC                      `I_TYPE_IMM_LSB +: `I_TYPE_IMM_WIDTH

`define     U_TYPE_IMM_WIDTH                    20
`define     U_TYPE_IMM_LSB                      12
`define     U_TYPE_IMM_MSB                      `U_TYPE_IMM_LSB + `U_TYPE_IMM_WIDTH - 1
`define     U_TYPE_IMM_LOC                      `U_TYPE_IMM_LSB +: `U_TYPE_IMM_WIDTH
